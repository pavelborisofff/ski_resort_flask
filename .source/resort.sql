...
INSERT INTO `valrisk` VALUES (1,4);
...
INSERT INTO `weather_0_local` VALUES (1,'Роза Долина','ROSA VALLEY','2020-12-17 03:46:57.162120','rosa',0,560,'ОБЛАЧНО',18,'ОБЛАЧНО',2,1,'NE','ВЕСЕННИЙ',118,12,'-',4,0,'-'),(2,'РОЗА СТАДИОН','ROSA STADIUM','2020-12-09 12:56:02.725530','root',0,960,'СОЛНЦЕ',-20,'СОЛНЦЕ',-10,5,'W','СВЕЖИЙ',3,2,'',1,0,'-'),(3,'ГОРНАЯ ОЛИМПИЙСКАЯ ДЕРЕВНЯ','ALPINE OLYMPIC VILLAGE','2020-12-09 12:56:02.795601','root',0,1100,'ПАСМУРНО',20,'ПАСМУРНО',23,3,'NE','СВЕЖИЙ',20,10,'',1,0,'-'),(4,'РОЗА 1600','ROSA 1600','2020-12-09 12:56:02.876098','root',0,1600,'СОЛНЦЕ',-2,'СОЛНЦЕ',-1,5,'W','СВЕЖИЙ',2,1,'',1,0,'-'),(5,'РОЗА ПИК','ROSA PEAK','2020-12-09 12:56:02.951380','root',0,2320,'СОЛНЦЕ',25,'СОЛНЦЕ',22,3,'SE','СВЕЖИЙ',2,1,'',1,0,'-'),(6,'Южный склон','SOUTHERN SLOPE','2020-12-17 01:00:04.912253','rosa',0,1925,'ПАСМУРНО',-2,'СОЛНЦЕ',5,5,'W','СВЕЖИЙ',2,1,'',1,0,'-');
...
-- Dump completed on 2020-12-17 11:30:45
